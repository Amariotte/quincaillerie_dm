...
export default function SousComptesScreen() {
  ...
  const showInitialLoader = isLoading && sousComptes.data.length === 0;
  const showErrorState = isError && sousComptes.data.length === 0;
  ...
  return (
    <SafeAreaView style={[sharedStyles.safeArea, { backgroundColor }]}>
      ...
      <FlatList
        data={showInitialLoader || showErrorState ? [] : filteredSousComptes}
            ...
            >
              <View style={sharedStyles.invoiceTopRow}>
                <View style={sharedStyles.invoiceRefBlock}>
                  ...
                  >
                    {sousCompte.description?.trim() || "Aucune description"}
                  </Text>
                </View>
              </View>
